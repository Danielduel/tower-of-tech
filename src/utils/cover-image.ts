...
const getPlaylistColorOverride = (playlistName: string) => {
  const color = (() => {
    switch (true) {
      // Misc:
      case playlistName.startsWith("Old"):
        return "#3b4252";

      // ToT:
      // slower will be #4c566a
      case playlistName.startsWith("Adep"):
        return "#5e81ac";
      case playlistName.startsWith("Acc"):
        return "#88c0d0";
      case playlistName.startsWith("Mid"):
        return "#a3be8c";
      case playlistName.startsWith("Fas"):
        return "#ebcb8b";
      case playlistName.startsWith("Sonic"):
        return "#d08770";
      ...
      case playlistName.startsWith("Rainbow"):
        return "#b48ead";
      default:
        return null;
    }
...
const getPlaylistCover = (playlistName: string) => {
  switch (true) {
    ...
    case playlistName.endsWith("Comfy"):
      return fromAssets("detail/comfy.png");
    case playlistName.endsWith("Tech"):
      return fromAssets("detail/tech.png");
    case playlistName.endsWith("Hitech"):
      return fromAssets("detail/hitech.png");
    case playlistName.endsWith("Anglehell"):
      return fromAssets("detail/anglehell-2.png");
    case playlistName.endsWith("Tempo"):
      return fromAssets("detail/tempo-2.png");

    // ToT Misc:
    case playlistName.endsWith("Surf"):
      return fromAssets("detail/surf.png");
    default:
      return fromAssets("detail/default.png");
  }
};
