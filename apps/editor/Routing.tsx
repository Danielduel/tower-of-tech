...
import { PlaylistInstallGuidePlatform, PlaylistInstallGuidePCVRSteam, PlaylistInstallGuideModAssistant } from "@/apps/editor/pages/home/PlaylistInstallGuide.tsx";
    ...
    <Routes>
      ...
      <Route path={routing.home.root}>
        ...
        <Route path={routing.home.playlistInstallGuide.root}>
          <Route path={routing.home.playlistInstallGuide.modAssistant} element={MainLayoutShell(PlaylistInstallGuideModAssistant)} />
