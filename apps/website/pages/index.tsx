  ...
  return (
    <VisualNovelContainer ref={ref}>
      <VisualNovelBody>
        ...
        <i>Where is the fun part of Beat Saber?</i>. I have a few playlists for you, those playlists cover skillset
        between <i>I've passed my first Expert map!</i> and <i>Hey, do you have 14nps angle tech for me?</i>.
      </VisualNovelBody>
      <VisualNovelActions>
        <VisualNovelLink
