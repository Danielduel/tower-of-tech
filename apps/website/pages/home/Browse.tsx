    ...
    return (
      <VisualNovelStep ref={ref}>
        <VisualNovelStepExplanation>
          ...
          Those roughly translate to <i className="text-[#5e81ac] font-bold highlight">&gt;4</i>,{" "}
          ...
          <br />
          Second segment:<br />
          <i className="font-bold highlight">Comfy</i>, <i className="font-bold highlight">Tech</i>,{" "}
          <i className="font-bold highlight">Hitech</i>, <i className="font-bold highlight">Anglehell</i>,{" "}
          ...
          <i className="font-bold highlight">Comfy</i>, great for semiadvanced tech crowd.<br />
          <i className="font-bold highlight">Hitech</i> is much more complex than{" "}
          <i className="font-bold highlight">Tech</i>, targets superadvanced tech players.<br />
          <i className="font-bold highlight">Anglehell</i> and <i className="font-bold highlight">Tempo</i>{" "}
          are especially hard cases of <i className="font-bold highlight">Hitech</i>.
        </VisualNovelStepExplanation>
        <VisualNovelDivider />
        <VisualNovelStepInlineATag
          download
