...
export const More = forwardRef<HTMLDivElement>((_, ref) => {
  return (
    <VisualNovelStep ref={ref}>
      ...
      <VisualNovelDivider />
      The speed part:<br />
      Adep, Acc, Mid, Fas, Sonic - are based on burstable swings per second, which roughly translated to nps would
      be...<br />
      <br />
      4nps for Adep<br />
      4-6nps for Acc<br />
      ...
      <br />
      <i>Comfy</i>{" "}
      consists mostly of simple/comfy moves, but it has sections which players new to tech would find harder than usual.
      ...
      <br />
      <i>Tech</i>{" "}
      introduces a lot of sidecuts, returns, bottomstreams, inlines, nonlinear jumps, ocassional palmups and rolls that
      aren't essential to the flow.<br />
      <br />
      <i>Hitech</i>{" "}
      ...
      <hr />
      <VisualNovelDivider />
      Now, since this naming convention is often confusing, there are talks about how to rename those and to rework the
      gradation.
      <VisualNovelDivider />
      <VisualNovelStepLink
